...
4. In the **Create API key** side panel, under **APIs that can be accessed using this key**, click the dropdown menu (Select API restrictions).
    
5. For **Cloud Speech-to-Text API**, check the box, and then click **OK**.
    
6. Click **Create**.
    
7. Copy the key you just generated, and then click **Close**.
...
1. In the **Navigation menu**, select **Compute Engine** > **VM instances**. You should see a `linux-instance` listed in the VM instances window.
